...
const clubs: Club[] = [
  {
    ...
    description: 'Espectacular campo de 18 hoyos en una isla privada rodeada por el embalse de Valdecañas. Diseñado por los hermanos Azurmendi, ofrece un recorrido único con agua en juego en casi todos los hoyos. Sede de ambas rondas del torneo SSS Ryder Weekend.',
    round: 'R1 & R2',
    roundDay: 'Sábado 31 Enero - Domingo 1 Febrero',
    format: 'Scramble + Singles Matchplay',
    par: 72,
    holes: 18,
    length: '6.400m',
